            ...
            <div className="flex flex-col bg-slate-50 w-full gap-4 px-4 py-8 rounded-lg">
                ...
                {info ? 
                    (<>
                        ...
                        <RecordingProperty label="Spraying Duration" value={info?.sprayingTime} />
                        <RecordingProperty label="Chemical Volume" value={String(info?.volumeSprayed)} />
                        <RecordingProperty label="Average Flow Rate" value={String(info?.avgFlowRate)} />
                    </>
                ): null}
                <div>
                    <h4>Notes:</h4>
                    <p className="text-xs p-2 bg-gray-300 rounded-md">On-site inspection completed, identified evidence of rodent activity in kitchen area. Placed bait stations and sealed entry points. Recommended sanitation measures to prevent future infestations. Follow-up visit scheduled in two weeks for monitoring and further treatment if necessary</p>
                </div>
